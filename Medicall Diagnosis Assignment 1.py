...
def check_for_leakage(df1, df2, patient_col):
    ...
    df1_patients_unique = train_df.PatientId.values
    df2_patients_unique = valid_df.PatientId.values
    
    ids_train_set = set(df1[patient_col])
    ids_valid_set = set(df2[patient_col])
    
    patients_in_both_groups =  list(ids_train_set.intersection(ids_valid_set))
